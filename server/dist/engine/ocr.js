...
function genericFields(requirement, name) {
    const base = [{ key: 'name', label: 'Name', value: name, confidence: 90 }];
    switch (requirement) {
        case 'identity':
...
export function extractFields(requirement, seedOrFile, docType, applicantName = 'Salman') {
...
function kindLabel(docType, requirement) {
    const map = {
...
export function ocrPipeline(steps, cb) {
